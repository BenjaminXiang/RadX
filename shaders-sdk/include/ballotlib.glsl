...
highp uvec4 sgr_blt(in bvec2 k) { return uvec4(encodeMorton64 (u32x2_t(subgroupBallot(k[0])[0],subgroupBallot(k[1])[0])),0u.xx); };
...
highp uvec4 sgr_prt(in m8pq u8x2_t k) { return uvec4(encodeMorton64 (u32x2_t(subgroupPartitionNV(k[0])[0],subgroupPartitionNV(k[1])[0])), 0u.xx); };
#endif
