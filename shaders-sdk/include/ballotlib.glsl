...
uvec2 sgr_blt(in bvec2 k) { return encodeMorton64 (u32x2_t(subgroupBallot(k[0])[0],subgroupBallot(k[1])[0])); };
...
uvec2 sgr_prt(in m8pq u8x2_t k) { return encodeMorton64 (u32x2_t(subgroupPartitionNV(k[0])[0],subgroupPartitionNV(k[1])[0])); };
#endif
